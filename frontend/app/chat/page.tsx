...
export default function ChatInterface() {
  ...
  const handleSendMessage = async () => {
    ...
    setTimeout(() => {
      ...
      if (inputValue.toLowerCase().includes('salary') || inputValue.toLowerCase().includes('personal') || inputValue.toLowerCase().includes('phone')) {
        aiResponse = {
          id: (Date.now() + 1).toString(),
          content: 'I cannot access personal or sensitive information like salaries, personal contact details, or confidential employee data. This information is protected by our privacy policies. Is there something else I can help you with?',
          sender: 'ai',
          timestamp: new Date(),
          isProtected: true,
        }
        ...
        aiResponse = {
          id: (Date.now() + 1).toString(),
          content: 'Based on our company documents, here\'s what I found: Our remote work policy allows employees to work from home up to 3 days per week, with core collaboration hours from 10 AM to 3 PM in your local timezone. All remote work must be pre-approved by your direct manager.',
          sender: 'ai',
          timestamp: new Date(),
          sources: ['Employee Handbook v2.3', 'Remote Work Policy 2024', 'HR Guidelines']
        }
      }
